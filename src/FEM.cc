...
void FEM::ImposeDirichletEncastre(vector<vector<int> > vD, float Klarge){
...
vector<vector<float> > FEM::InvertMatrixEigen(vector<vector<float> > m1) { 
...
vector<vector<float> > FEM::MultiplyMatricesEigen(vector<vector<float> > m1, vector<vector<float> > m2) {
